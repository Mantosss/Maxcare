...
import AdminSidebar from "@/layout/admin/Sidebar"; // adjust path as needed
...
const AdminView = () => {
  ...
  const scrollTo = (section: "doctors" | "appointments") => {
    const ref = section === "doctors" ? doctorsRef : appointmentsRef;
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      {/* Sidebar */}
      <AdminSidebar onScrollTo={scrollTo} />
      ...
      <main className="flex-1 ml-64 px-6 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Doctors list — scroll anchor */}
          <div ref={doctorsRef} className="scroll-mt-6">
          ...
          {/* Recent Appointments — scroll anchor */}
          <div ref={appointmentsRef} className="scroll-mt-6">
